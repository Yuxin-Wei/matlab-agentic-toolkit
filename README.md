...
[![Latest Release](https://img.shields.io/github/v/release/matlab/matlab-agentic-toolkit)](https://github.com/matlab/matlab-agentic-toolkit/releases/latest)
[![Release Date](https://img.shields.io/github/release-date/matlab/matlab-agentic-toolkit)](https://github.com/matlab/matlab-agentic-toolkit/releases/latest)
...
These steps show you how to use the MATLAB Agentic Toolkit to install the MATLAB MCP Core Server and add skills to your agent.
...
| [**RF and Mixed Signal**](skills-catalog/README.md#rf-and-mixed-signal-rf-and-mixed-signal) | Antenna Toolbox, RF Toolbox, RF PCB Toolbox, and SerDes Toolbox |
...
| [**Signal Processing**](skills-catalog/README.md#signal-processing-signal-processing) | Signal Processing Toolbox, DSP System Toolbox, Wavelet Toolbox, and DSP HDL Toolbox |
| [**Test and Measurement**](skills-catalog/README.md#test-and-measurement-test-and-measurement) | Data Acquisition Toolbox and Industrial Communication Toolbox |
